...
<html>
<head>
	<title>Another Restricted Page</title>
...
<body>
	<h1>Another Restricted Page</h1>

	<h2>Welcome to another restricted page, you are logged in as <?= $email ?>  This was written from a HTML block</h2>
	...
	<!-- Notice how we passed the path to the log out destination page as the second agrument to the javascript logOut function. !-->
</body>
